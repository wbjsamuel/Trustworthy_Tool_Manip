...
from model.vision.obs_tokenizer import ObsTokenizer
...
from model.vision.multi_image_obs_encoder_dino import MultiImageObsEncoder
...
class DP2(BasePolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        # normalize input
        nobs = obs_dict
        nobs['qpos'] = self.normalizer['qpos'].normalize(obs_dict['qpos'])
    ...
    def compute_loss(self, batch, **kwargs):
        ...
        nobs = batch['obs']
        nobs['qpos'] = self.normalizer['qpos'].normalize(batch['obs']['qpos'])
